...
internal static class FlightContract
{
    public const string ConsumerName = "Platform Smoke Client";
    public const string ProviderName = "Flight API";
    public const string AppName = "Flight.Api.Contract";
    ...
    public static async Task WritePactAsync()
    {
        ...
        pactBuilder
            .UponReceiving("A request for the flight service health page")
