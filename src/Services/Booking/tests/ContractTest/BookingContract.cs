...
internal static class BookingContract
{
    public const string ConsumerName = "Platform Smoke Client";
    public const string ProviderName = "Booking API";
    public const string AppName = "Booking.Api.Contract";
    ...
    public static async Task WritePactAsync()
    {
        ...
        pactBuilder
            .UponReceiving("A request for the booking service health page")
